...
import projectExample from '../../assets/Kochmon/projectExample.webp';
                    ...
                    <div className="projects-slider__item-bottom">
                        ...
                        <div data-speed="0.2" id="paralax-text" className="projects-slider__item-info">
                            <AnimatedText as='h6' className="text-fade-in projects-slider__item-info__title">
                                ...
                                Жилой комплекс «Kochmon city»
                            </AnimatedText>
                            <AnimatedText as='p' className="text-fade-in projects-slider__item-info__text block-text">
                                {/* {slides[activeSlide].description} */}
                                Эксклюзивный проект городка — это образец идеальной гармонии формы, света и цвета,
                                являющийся безукоризненностью вкуса его создателей. В жилом микрорайоне идеально все, начиная от архитектурного проекта домов до внутренней инфраструктуры и благо устройства дворов.
                            </AnimatedText>
